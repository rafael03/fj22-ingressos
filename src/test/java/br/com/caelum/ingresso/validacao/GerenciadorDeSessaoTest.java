...
public class GerenciadorDeSessaoTest {
	...
	@Test
	public void garanteQueNaoDevePermitirSessoesIniciadaDentroDoHorarioDeUmaSessaoJaExistente() {
		List<Sessao> sessoesDaSala = Arrays.asList(sessaoDasDez);
		GerenciadorDeSessao gerenciador = new GerenciadorDeSessao(sessoesDaSala);
		Sessao sessao = new Sessao(sessaoDasDez.getHorario().plusHours(1).minusHours(1), rogueOne, sala3d);
		Assert.assertFalse(gerenciador.cabe(sessao));
	}
